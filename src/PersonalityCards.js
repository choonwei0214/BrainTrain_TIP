...
import { GiLion, GiPolarBear, GiWerewolf, GiDolphin } from 'react-icons/gi';
        ...
        <div className="personalityCards">
            <Row className="text-center">
                ...
                <Col><Card><h4>MBTI</h4><div className="personalityImg">
                    ...
                    {mbti === "INFJ" && <MdEmojiPeople className='personalityCard-icon' />}
                ...
                <Col><Card><h4>Chronotype</h4><div className="personalityImg">
                    ...
                    {chronotype === "Wolf" && <GiWerewolf className='personalityCard-icon' />}
