...
import { MdHistoryEdu,MdOutlineScience } from 'react-icons/md';
...
const classes = [
    ...
    { _id: 2, name: ['PHYSICS', 'BIOLOGY', 'CHINESE', 'GEOGRAPHY'], color: ["#EC9B00","#119DA4","#846267","#63458A"], icons:[<GiAtom/>,<RiPlantLine/>,<TranslationOutlined />,<GlobalOutlined />,<MdOutlineScience/>], date: ["Monday 12/9", "Tuesday 13/9", "Tuesday 13/9", "Tuesday 13/9"], time: ["1300-1400", "0800-0900", "0900-1000", "1030-1130"] },
    { _id: 3, name: ['SCIENCE', 'ART', 'MUSIC', 'SUBJECT'], color: ["#C37D92","#00BBF9","#F15BB5","#9B5DE5"], icons:[""], date: ["Tuesday 13/9", "Tuesday 13/9", "Wednesday 14/9", "Wednesday 14/9"], time: ["1130-1230", "1300-1400", "0800-0900", "0900-1000"] }
];
